...
function firstFunction() {
	...
	button.addEventListener('click', (e) => {
		console.log(`'Задание1', Переменная first = ${first}`)
	})
}
...
console.log('Задание3', multiply(x, y));
...
function greet(firstName) {
	console.log(`Задание4, Hello, ${firstName}`)
}
...
console.log('Задание5', calculateArea(width, height));
...
console.log('Задание7', secondFunction()); //Выведет 15
...
console.log('Задание7', secondFunction(2, 3)); //Выведет 5
...
console.log('Задание8', thirdFunction()); //Выведет 6
...
console.log('Задание8', thirdFunction(4)); //Выведет 12
console.log('Задание8', thirdFunction(5, 6)); //Выведет 30
...
console.log('Задание9', greetGuest());
console.log('Задание9', greetGuest('Nataly'));
...
console.log('Задание10', result); //Выведет 2
...
console.log('Задание11', total); //Выведет 15
...
const findAnimal = () => {
	const cat = 'Котик'
	console.log('Задание14', `${cat}, ${rabbit}`)
}
findAnimal();
...
console.log('Задание16','Возраст пользователя '+ calculateAge(currentYear, friendYearOfBirth)+ ' лет')
...
const countMyAge = (a,b) => {
	return a-b;
}
console.log('Задание17','Мне '+ countMyAge(currentYear, myBirthYear))
...
console.log('Задание18',"Результат=" + powerNumber(5));